...
def main():
    ...
    tornado.options.define('secure', default=False, type=bool, help='Set to true to enable secure connections (SSL)')
    tornado.options.parse_command_line()

    ssl_options = None
    if options.secure:
        ssl_options = {'certfile': os.path.join('certs/server.crt'),
